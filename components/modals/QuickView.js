                ...
                <div className="modal-content rounded-0 p-5 border-0">
                    <Modal.Body className="row p-0 gap-3">
                        <div className="col-12 col-lg-5 flex-grow-1">
                            <div role="button" type="button" className="quickView-modal-remove-btn mt-2 mb-2 mb-lg-0 bg-primary d-flex justify-content-center align-items-center" style={{ height: "40px", width: "40px" }} onClick={handleClose}><Image src='/icons/remove-white.svg' alt="" /></div>
                        ...
                        <div className="col-12 col-lg-6 position-relative flex-grow-1">
                            ...
                            <div className="d-flex gap-4 mb-5 flex-wrap">
                                ...
                                <div className="d-flex align-items-center" style={{ gap: "3px" }}>
                                    <Image src='/icons/star-yellowy.svg' alt="" className="icon--12px" />
                                    <Image src='/icons/star-yellowy.svg' alt="" className="icon--12px" />
                                    <Image src='/icons/star-yellowy.svg' alt="" className="icon--12px" />
                                    <Image src='/icons/star-yellowy.svg' alt="" className="icon--12px" />
                                    <Image src='/icons/star-yellowy.svg' alt="" className="icon--12px" />
                            ...
                            <div className="d-flex gap-3 mb-5">
                                ...
                                <div className="d-flex gap-3 ">
                                    <Image src='/icons/facebook-grey.svg' alt="" className="icon--12px" style={{ height: "16px", width: "16px" }} />
                                    <Image src='/icons/twitter-grey.svg' alt="" className="icon--12px" style={{ height: "16px", width: "16px" }} />
                                    <Image src='/icons/pinterest-grey.svg' alt="" className="icon--12px" style={{ height: "16px", width: "16px" }} />
                                    <Image src='/icons/instagram-grey.svg' alt="" className="icon--12px" style={{ height: "16px", width: "16px" }} />
                                </div>
                            </div>
                        </div>
                    </Modal.Body>
