...
export const ProductCard = ({ product, swiper = false }) => {
    ...
    return (
        <div className={swiper ? "product-card position-relative h-100" : "product-card position-relative col-6 col-md-4 col-lg-3 h-100"}>
            <Card className="border-0 rounded-0 position-relative d-flex flex-column h-100">
                ...
                <Card.Footer className="card-body bg-light-subtle d-flex flex-column align-items-center position-relative mt-auto text-center flex-grow-1">
