...
export const ShopProductCard = ({ product }) => {
    ...
    return (
        <Col sm={6} lg={4} className="shop-grid-products">
            <div className="shop-card position-relative h-100">
                <Card className="border-0 rounded-0 position-relative d-flex flex-column h-100">
                    ...
                    <Card.Footer className="card-body bg-light-subtle d-flex flex-column align-items-center position-relative mt-auto flex-grow-1">
