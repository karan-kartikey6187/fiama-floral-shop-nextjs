                    ...
                    <Row className="login-main mt-7 mb-7 px-4 px-lg-0">
                        ...
                        <div className="col-12 col-lg-6">
                            <div className="d-flex flex-column justify-content-center align-items-center" style={{ marginTop: "50px" }}>
                                ...
                                <Link href="/auth/signup" className="fw-medium px-5 py-2 text-center create-account-btn shop-now-btn btn rounded-0 btn-primary text-white text-nowrap text-decoration-none" role="button">CREATE ACCOUNT</Link>
                            </div>
                        </div>
                    </Row>
                </Container>
